...
Rules: .claude/rules/
Skills:
- `/go_dev` - Go 1.23 backend development
- `/wails_dev` - Wails framework (Go-Web bindings)
- `/frontend_dev` - Svelte 5 + Tailwind + shadcn-svelte
- `/software_design` - SOLID/Patterns architecture
- `/commit` - Git commits (ES, Conventional, NO AI sigs)
- `/pr` - Pull Requests & GitHub CLI workflow
